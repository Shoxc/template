...
function ef() {
    let x;
    setInputFilter(document.getElementById("id1"), function (value) {
        return /^-?\d*[.,]?\d*$/.test(value);
    });
    if (document.getElementById("id1").value === "") {
        document.getElementById("id2").innerHTML = "0.00x";
        document.getElementById("id3").innerHTML = "0.00x";
    } else {
        x = parseFloat(document.getElementById("id1").value);
        let y = x / 100;
        let z = x - y;
        document.getElementById("id2").innerHTML = y.toString();
        document.getElementById("id3").innerHTML = z.toString();
    }
}
...
function tk(at) {
    ...
    document.getElementById("id1").value = x.toString();
    let y = x / 100;
    let z = x - y;
    document.getElementById("id2").innerHTML = y.toString();
    document.getElementById("id3").innerHTML = z.toString();
